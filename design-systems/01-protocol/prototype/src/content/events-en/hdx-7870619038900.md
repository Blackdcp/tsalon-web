...
faq:
  - question: "Is this event free, and how do I register?"
    answer: "This is a free offline event. Registration runs on Huodongxing via the link at the top of the page; seats are limited, so book early."
  - question: "Will reusable engineering materials be shared?"
    answer: "Four speakers cover cross-agent long-term memory, intelligent model gateways, Vibe Coding backend development, and deliverable Agent applications, with an emphasis on architecture and lessons learned; any slides depend on what each speaker shares on site."
  - question: "What background fits this event best?"
    answer: "Engineers, tech leads, and founders who are building or planning to move an AI demo into production; topics span memory, backend, model routing, and Agent orchestration."
  - question: "If I miss the live event, can I still access the content?"
    answer: "Watch for T Salon's follow-up articles and archive; the key points of this event are distilled into the community archive as text and visuals for post-event search and citation."
featured: true
draft: false
